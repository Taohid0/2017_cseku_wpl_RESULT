...
a:hover {
	...
	<body>
		<!..............option bar creation......................>
		<h1 align="center"><font color="#2F4F4F">Result Input</font></h1>
		<ul>
  ...
  <li><a href="marksetup.php"><h4>Marks Setup</h4></a></li>
	...
	<input type= "submit" value="load" name="load" onclick="form.action='inputmarks.php?epr=save'"/><br>
	...
	//		$epr1=$_GET['epr'];
		...
		{	
		$connect = mysqli_connect($hostname,$username,$password,$databaseName);
		$sql2 = ("SELECT `MarksHeader`,`MarksMax` FROM tbl_course_marks_setup WHERE tbl_course_marks_setup.`CourseID`= '$courseID'");
	...
	<input type="submit" value="submit" name="submit" id="submit" onclick="form.action='inputmarks.php?epr=save&new=go'">
	<?php 
