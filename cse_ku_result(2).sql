...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2017 at 07:04 AM
...
--
-- Dumping data for table `tbl_course_marks_result`
--

INSERT INTO `tbl_course_marks_result` (`CourseID`, `TeacherID`, `SessionID`, `TermID`, `StudentID`, `MarksID`, `MarksValue`) VALUES
('CSE-1103', '', '2012-13', '1st', '170202', '101', 15),
('CSE-1103', '', '2012-13', '1st', '170202', '102', 20),
('CSE-1103', '', '2012-13', '1st', '170202', '103', 20),
('CSE-1103', '', '2012-13', '1st', '170222', '101', 30),
('CSE-1103', '', '2012-13', '1st', '170222', '102', 30),
('CSE-1103', '', '2012-13', '1st', '170222', '103', 20),
('CSE-1103', '', '2012-13', '1st', '170233', '101', 10),
('CSE-1103', '', '2012-13', '1st', '170233', '102', 30),
('CSE-1103', '', '2012-13', '1st', '170233', '103', 10),
('CSE-3200', '', '2013-14', '6th', '140202', '101', 20),
('CSE-3200', '', '2013-14', '6th', '140202', '102', 20),
('CSE-3200', '', '2013-14', '6th', '140202', '103', 20),
('CSE-3200', '', '2013-14', '6th', '140202', '104', 20),
('CSE-3200', '', '2013-14', '6th', '140224', '101', 3),
('CSE-3200', '', '2013-14', '6th', '140224', '102', 3),
('CSE-3200', '', '2013-14', '6th', '140224', '103', 3),
('CSE-3200', '', '2013-14', '6th', '140224', '104', 3);
...
CREATE TABLE `tbl_course_marks_result_publish` (
  ...
  `MarksTotal` varchar(50) DEFAULT NULL,
  `MarksGrade` varchar(10) DEFAULT NULL,
  `GPA` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_course_marks_result_publish`
--

INSERT INTO `tbl_course_marks_result_publish` (`CourseID`, `TeacherID`, `TermID`, `SessionID`, `StudentID`, `MarksTotal`, `MarksGrade`, `GPA`) VALUES
('CSE-1103', NULL, '1st', '2012-13', '170202', '55', ' B-', '2.75'),
('CSE-1103', NULL, '1st', '2012-13', '170222', '80', ' A+', '4'),
('CSE-1103', NULL, '1st', '2012-13', '170233', '50', ' C+', '2.5'),
('CSE-3200', NULL, '6th', '2013-14', '140202', '80', ' A+', '4'),
('CSE-3200', NULL, '6th', '2013-14', '140224', '12', ' F', '0');
...
CREATE TABLE `tbl_course_marks_setup` (
  ...
  `MarksMax` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_course_marks_setup`
--

INSERT INTO `tbl_course_marks_setup` (`ID`, `CourseID`, `TeacherID`, `SessionID`, `TermID`, `MarksID`, `MarksHeader`, `MarksMax`) VALUES
(14, 'CSE-1103', NULL, '2012-13', '1st', '101', 'SEC A', '30'),
(15, 'CSE-1103', NULL, '2012-13', '1st', '102', 'SEC B', '30'),
(16, 'CSE-1103', NULL, '2012-13', '1st', '103', 'CT', '20'),
(18, 'CSE-3200', NULL, '2013-14', '6th', '101', 'CT', '30'),
(19, 'CSE-3200', NULL, '2013-14', '6th', '102', 'SEC A', '20'),
(20, 'CSE-3200', NULL, '2013-14', '6th', '103', 'SEC B', '20'),
(21, 'CSE-3200', NULL, '2013-14', '6th', '104', 'SEC C', '20'),
(22, 'CSE-1105', NULL, '2012-13', '1st', '101', 'SEC A', '30'),
(23, 'CSE-1105', NULL, '2012-13', '1st', '102', 'SEC B', '30');
...
--
-- Dumping data for table `tbl_course_student_registration`
--

INSERT INTO `tbl_course_student_registration` (`StudentID`, `TermID`, `CourseID`, `SessionID`, `IsRetake`, `IsApproved`, `IsDeleted`) VALUES
('140202', '6th', 'CSE-3200', '2013-14', 0, 1, 0),
('140224', '6th', 'CSE-3200', '2013-14', 0, 1, 0),
('170201', '1st', 'CSE-1101', '2012-13', 0, 1, 0),
('170202', '1st', 'CSE-1103', '2012-13', 0, 1, 0),
('170222', '1st', 'CSE-1101', '2012-13', 0, 1, 0),
('170233', '1st', 'CSE-1101', '2012-13', 0, 1, 0),
('170222', '1st', 'CSE-1103', '2012-13', 0, 1, 0),
('170233', '1st', 'CSE-1103', '2012-13', 0, 1, 0),
('110201', '1st', 'CSE-1105', '2012-13', 0, 1, 0),
('110202', '1st', 'CSE-1105', '2012-13', 0, 1, 0),
('1201', '3rd', 'CSE-3201', '2014-15', 0, 1, 0);
...
INSERT INTO `tbl_course_teacher` (`CourseID`, `TeacherID`, `SessionID`, `TermID`) VALUES
('CSE-1103', 'T-10005', '2012-13', '1st'),
('CSE-1105', 'T-10009', '2012-13', '1st'),
('CSE-3201', 'T-10004', '2014-15', '6th'),
('CSE-3200', 'T-10001', '2013-14', '3rd');
...
--
-- Dumping data for table `tbl_marks_grade`
--

INSERT INTO `tbl_marks_grade` (`ID`, `MarksMin`, `MarksMax`, `MarksGrade`, `GPA`) VALUES
(1, 45, 49, 'C', 2.25),
(2, 50, 54, 'C+', 2.5),
(3, 55, 59, 'B-', 2.75),
(4, 60, 64, 'B', 3),
...
--
-- Indexes for table `tbl_course_marks_setup`
--
ALTER TABLE `tbl_course_marks_setup`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `tbl_marks_grade`
--
ALTER TABLE `tbl_marks_grade`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `tbl_course_marks_setup`
--
ALTER TABLE `tbl_course_marks_setup`
  MODIFY `ID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `tbl_marks_grade`
--
ALTER TABLE `tbl_marks_grade`
